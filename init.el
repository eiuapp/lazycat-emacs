...
;; (add-subdirs-to-load-path "~/lazycat-emacs/self/site-lisp/")
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("0662e3fbfe80821ee133053f9a68f87fa83331bc45add5f85e19633597d41ffc" "971879961b0b2542a825af34feabb7804e95fec210157cccaaebba63ebf62e2b" "13ad38f22ce6b90008d07bae6f0a934e2af8218870617eba1c899def9972b646" "2821ae9b03ba6a9d9fc8941e86f33473a8dbde75068ba9200d4f048a1aaa66de" default)))
 ...
 '(imaxima-pt-size 12)
 '(package-selected-packages (quote (pyim-wbdict pyim ## w3m w3 edit-server)))
 '(safe-local-variable-values
   (quote
    ((org-export-html-style . "<link rel=\"stylesheet\"                type=\"text/css\" href=\"slides.css\" />")
     (eval setq-local org-roam-directory
           (expand-file-name "./"))
     (org-roam-directory . "~/install/git/wiki/emacs")
